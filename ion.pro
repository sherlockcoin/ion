...
SECP256K1_INCLUDE_PATH=C:/ion-master-old-old/src/secp256k1/include
SECP256K1_LIB_PATH=C:/ion-master-old-old/src/secp256k1/.libs
}
...
LIBS += $$PWD/src/secp256k1/src/libsecp256k1_la-secp256k1.o
    ...
    isEmpty(SECP256K1_LIB_PATH) {
        windows:SECP256K1_LIB_PATH=C:/ion-master-old-old/src/secp256k1/.libs
    }
    isEmpty(SECP256K1_INCLUDE_PATH) {
        windows:SECP256K1_INCLUDE_PATH=C:/ion-master-old-old/src/secp256k1/include
    }
}
